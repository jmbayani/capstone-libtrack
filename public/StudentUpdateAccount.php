        ...
        <div class="container-info">
            <form action="update_user.php" method="POST">
                <div class="info-details">
                    ...
                    <select id="department" name="department" value="<?= htmlspecialchars($user['Department'])?>" onchange="updateCourses()" required>
                        <option value="cea" <?= ($user['Department'] == 'cea') ? 'selected' : '' ?>>College of Engineering and Architecture</option>
                        <option value="ics" <?= ($user['Department'] == 'ics') ? 'selected' : '' ?>>Institute of Computer Studies</option>
                        <option value="iarch" <?= ($user['Department'] == 'iarch') ? 'selected' : '' ?>>Institute of Architecture</option>
                        <option value="cbea" <?= ($user['Department'] == 'cbea') ? 'selected' : '' ?>>College of Business, Entrepreneurship and Accountancy</option>
                        <option value="ced" <?= ($user['Department'] == 'ced') ? 'selected' : '' ?>>College of Education</option>
                        <option value="cas" <?= ($user['Department'] == 'cas') ? 'selected' : '' ?>>College of Arts and Sciences</option>
                        <option value="ihk" <?= ($user['Department'] == 'ihk') ? 'selected' : '' ?>>Institute of Human Kinetics</option>
                    </select>
                    </div>
                    ...
                    <select id="campus" name="campus" required>
                        ...
                        <option value="Boni" <?= ($user['Campus'] == 'Boni') ? 'selected' : '' ?>>Boni</option>
                        <option value="Pasig" <?= ($user['Campus'] == 'Pasig') ? 'selected' : '' ?>>Pasig</option>
                    </select>
