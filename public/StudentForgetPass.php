        ...
        <div class="back-container">
            ...
            <form action="backend_script/forgot_password.php" method="POST">
                ...
                <div class="password-container">
                    <input class="poppins-regular enter-pass" type="password" id="create-pass" name="new_pass" placeholder="Enter your new password" required>
                ...
                <div class="password-container">
                    <input class="poppins-regular reenter-pass" type="password" id="reenter-pass" name="confirm_pass" placeholder="Re-enter your new password" required>
                    <span><i id="reenter-pass-toggler" class="far fa-eye"></i></span>
                </div>
                <div class="button-container">
                    <button class="confirm-pass poppins-regular" name="update_password">Confirm</button>
                </div>
                </form>
            </div>
	</body>
...
function togglePasswordVisibility(togglerId, passwordInputId) {
...
togglePasswordVisibility("create-pass-toggler", "create-pass");
togglePasswordVisibility("reenter-pass-toggler", "reenter-pass");
