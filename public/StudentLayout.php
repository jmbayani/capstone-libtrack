...
if (!isset($_SESSION['logged_in']) || !$_SESSION['logged_in'] || !isset($_SESSION['name']) || $user_role  !== 'Student') {
...
<html lang="en">
	...
	<body class='poppins-regular'>
		<header class = "no-select">
			...
			<div class="important-popup" id="important-popup">
				<div class="popup-buttons">
					<a class="close-btn" onclick="closeNoticePopup()"><i class="icon bi bi-x-circle-fill"></i></a>
				</div>
				<img class="notice-image" src="img/important-notice.png" alt="Notice Logo" width="100" height="100">
				<p class="lilita-one-regular popup-title">Important Notice</p>
				<p class="poppins-bold popup-desc">Book Borrowed</p>
			</div>	
			<div class="penalty-popup" id="penalty-popup">
				<div class="popup-buttons">
					<a class="login-btn" onclick="closePenaltyPopup()"><i class="icon bi bi-x-circle-fill"></i></a>
				</div>
				<img class="notice-image" src="img/penalty-notice.png" alt="Penalty Logo" width="100" height="100">
				<p class="lilita-one-regular penalty-title">Penalty Notice</p>
				<p class="poppins-bold popup-desc">Book Information</p>
			</div>	-->
			<img class="header-spaces" src="img/libtrack-logo.png" alt="LibTrack Logo" width="300" height="100">
			<div class="user-display">
				<!--<a class="icon-settings" href="StudentBookBin.php" target="contentFrame"><i class="icon fa-solid fa-book"></i></a>-->
				<div class="notif-select">
					...
					<div class="notif-menu">
						...
						<div class="notif-footer">
							<hr>
							<a class="poppins-bold view-notif"  onclick="href='ViewAllNotifications.php'" target="contentFrame"> View All Notification </a>
						</div>
					</div>
				...
				<div class="settings-select">
					...
					<div class="settings-menu">
						...
						<a class="settings-sidebar-item" href="logout.php" >Log Out</a>
					</div>
				</div>
			</div>
		</header>
				...
				<div>
					<div class="dropdown-select">
						...
						<ul class="dropdown-menu" id="dropdown-menu">
							<a class="dropdown-sidebar-item" href="StudentBorrowBookHistory.php" target="contentFrame">Borrowed Books History</a>
							<a class="dropdown-sidebar-item" href="StudentReturnBookHistory.php" target="contentFrame">Returned Books History</a>
						</ul>
					</div>
				</div>
		...
		<iframe src="HomePage.php" class="content" name="contentFrame" height="750px" width="100%" title="LibTrack Home"></iframe>	
	</body>
	<style>
		body {
