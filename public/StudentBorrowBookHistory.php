...
<html lang="en">
	...
	<body class='poppins-regular'>
        ...
        <div class="container-bdcardcon1">
            <div>
                <h1 class="label-managefines">Borrowed Book History</h1>
            </div>
                    ...
                    <div class="fine-record">
                        <table class="fines-table" id="data-table">
                            ...
                            <tr class="fine-entry">
                                ...
                                <td><?= htmlspecialchars($row['Borrowed_Time'])?></td>
                            </tr>
                            <tr class="fine-entry">
                                <td><b>Author:</b></td>
                                <td><b>Publisher:</b></td>
                                <td><b>Date to Returned:</b></td>
                            </tr>
                            <tr class="fine-entry">
                            ...
                            <tr class="fine-entry">
                                ...
                                <td><b>Extended Return Date:</b></td>
                            </tr>
                            <tr class="fine-entry">
                                <td><?= htmlspecialchars($row['ISBN'])?></td>
                                <td><?= htmlspecialchars($row['Publication_Date'])?></td>
                                <td><?= htmlspecialchars($row['Extended_Returned_Date'])?></td>
                            </tr>
                            <tr class="fine-entry">
