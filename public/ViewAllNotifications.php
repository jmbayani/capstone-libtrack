	...
	<body class='poppins-regular'>
		<div class="sidebar">
			<div class="no-select sidebar-menu">
				<a class="description">All Notifications</a>
                <a class="options">Borrowed Books</a>
                <a class="options">Returned Books</a>
                <a class="options">Favorites</a>
                <a class="options">Fines</a>
                <a class="options">Change Password</a>
                <a class="options">Forgot Password</a>
                <a class="options">Update Account Details</a>
                <a class="options">Notification Settings</a>
			</div>
		</div>
