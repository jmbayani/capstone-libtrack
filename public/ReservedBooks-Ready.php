...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM book_reservation WHERE Reserve_ID = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $reserveID);
    $stmt->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['reserved_by'] = $row['Reserved_By'];
        $_SESSION['reserve_date'] = $row['Reserved_Date'];
        $_SESSION['ready_date'] = $row['Ready_Date'];
        $_SESSION['pickup_location'] = $row['Pick_up_Location'];
        $_SESSION['status'] = $row['Status'];
        $_SESSION['user_notes'] = $row['User_Notes'];
        $_SESSION['assign_librarian'] = $row['Assign_Librarian'];
        $_SESSION['librarian_notes'] = $row['Librarian_Notes'];
    ...
    $sqlUser = "SELECT * FROM user_info WHERE Institutional_Email = ?";
    $stmtUser = $conn->prepare($sqlUser);
    $stmtUser->bind_param("s", $_SESSION['user_email']);
    $stmtUser->execute();
                            ...
                            <div class="mb-book-container">
                                ...
                                <div class="container-buttons">
                                    ...
                                    <div class="dropdown" style="margin-left: 20px;">
                                        <button class="dropdown-button" onclick="toggleDropdown()"> Action </button>
                                    ...
                                    <div class="modal" id="reservedModal">
                                        <div class="modal-content">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" id="readyDate" min="<?= date('Y-m-d') ?>">
                                            </div>
                                    ...
                                    <div class="borrowed-state">
                                        ...
                                        <div>
                                            <div class="container-firstcolumn">
                                                ...
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['book_title']);?></span>
                                                </div>
                                            </div>
                                            <div class="container-firstcolumn">
                                                <span class="mb-titlelabel">Author</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['author']);?></span>
                                                </div>
                                            </div>
                                            <div class="container-firstcolumn">
                                                <span class="mb-titlelabel">ISBN</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['isbn']);?></span>
                                                </div>
                                            </div>
                                            <div class="container-firstcolumn">
                                                ...
                                                <?php if($_SESSION['status'] === 'Ready'): ?>
                                                    <div>
                                                        <span class="mb-normallabelready">Ready</span>
                                                    </div>
                                                <?php else: ?>
                                                    <div>
                                        ...
                                        <div>
                                            <div class="container-secondcolumn">
                                                ...
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['last_name'] . ', ' . $_SESSION['first_name']);?></span>
                                                </div>
                                            </div>
                                            <div class="container-secondcolumn">
                                                <span class="mb-titlelabel">Username</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['reserved_by']) ;?></span>
                                                </div>
                                            </div>
                                            <div class="container-secondcolumn">
                                                <span class="mb-titlelabel">Email</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['user_email']) ;?></span>
                                                </div>
                                            </div>
                                            <div class="container-secondcolumn">
                                                <span class="mb-titlelabel">Contact</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['contact_no']) ;?></span>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="container-thirdcolumn">
                                                ...
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['reserve_date']) ;?></span>
                                                </div>
                                            </div>
                                            <div class="container-thirdcolumn">
                                                <span class="mb-titlelabel">Ready Date</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['ready_date']) ;?></span>
                                                </div>
                                            </div>
                                            <div class="container-thirdcolumn">
                                                <span class="mb-titlelabel">Pick-up Location</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['pickup_location']) ;?> Section</span>
                                                </div>
                                            </div>
                                            <div class="container-thirdcolumn">
                                                <span class="mb-titlelabel">Total Copies</span>
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['total_copies']) ;?> Copies</span>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="container-fourthcolumn">
                                                ...
                                                <div>
                                                    <span class="mb-normallabel"><?php echo htmlspecialchars($_SESSION['assign_librarian']) ;?></span>
                                                </div>
                                            </div>
                                            <div class="container-fourthcolumn">
                                                ...
                                                <div>
                                                    <span class="mb-normallabel">
                                                        <?php echo htmlspecialchars($_SESSION['user_notes']) ;?>
                                                    </span>
                                                </div>
                                            </div>
                                            <?php if($_SESSION['librarian_notes']!==null): ?>
                                                <div class="container-fourthcolumn">
                                                    <span class="mb-titlelabel">Librarian Notes</span>
                                                    <div>
                                                        <span class="mb-normallabel">
                                                            <?php echo htmlspecialchars($_SESSION['librarian_notes']) ;?>
                                                        </span>
                                                    </div>
                                                </div>
                                            <?php endif;?>
