    ...
    <div class="maincontainer">
                ...
                <div class="book-info">
                    ...
                    <div class="container-buttons">
                        ...
                        <button class="button-editinfo" onclick="window.top.location.href='ManageBooks-EditInfo.php';"><i class="bi bi-pencil-square"></i> Edit Info</button>
                    </div>
                    <div class="bi-label">
                                ...
                                <div class="biblio-container1-bd">
                                    <div class="details-k">
                                        <div class="details-tl-bg">
                                            <span class="b-keyword-n">
                                                In "Book Lovers" by Emily Henry, one of the key lessons is the importance of self-discovery and personal growth through the relationships we build.
                                                The characters learn that stepping outside of their comfort zones can lead to unexpected connections and opportunities for love.
                                                This story emphasizes the value of being open to new experiences,
                                                as well as the impact that love and friendship can have on our understanding of ourselves and our desires.
                                            </span>
                                        </div>
                                    </div>
