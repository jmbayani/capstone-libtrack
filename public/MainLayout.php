...
<html lang="en">
	...
	<body class='poppins-regular'>
		<header class = "no-select">
			...
			<div class="popup" id="popup">
				...
				<div class="popup-buttons">
					<button class="login-btn" onclick="redirectLogin('LoginLibTrack.php')">Login</button>
				...
				<div>
					<div class="dropdown-select">
						...
						<ul class="dropdown-menu" id="dropdown-menu">
							<li><a class="dropdown-sidebar-item" id="studentLink1" href="StudentBorrowBookHistory.php" onclick="loginPopup()" target="contentFrame">Borrowed Books History</a></li>
							<li><a class="dropdown-sidebar-item" id="studentLink2" href="StudentReturnBookHistory.php" onclick="loginPopup()" target="contentFrame">Returned Books History</a></li>
						</ul>
					</div>
				</div>
		...
		<iframe src="HomePage.php" class="content" name="contentFrame" height="700px" width="100%" title="LibTrack Home"></iframe>
