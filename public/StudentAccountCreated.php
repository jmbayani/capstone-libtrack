...
<head>
    ...
    <title>Student Account Successfully Created</title>
</head>
<body>
    ...
    <div class="container-signup">
        <div class="container-info">
                ...
                <h2 class="header1-signup">Congratulations!!</h2>

                <label class="label1">Your LibTrack account has been successfully created</label><br>
                
                <label class="label2">Back to <a class="login-btnlink" href="LoginLibTrack.php" target="_self" rel="noopener noreferrer">Log in</a></label>
        </div>
    </div>
</body>
