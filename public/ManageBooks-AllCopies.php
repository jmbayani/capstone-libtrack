    ...
    <div class="maincontainer">
        ...
        <div class="book-info">
            ...
            <div class="container-buttons">
                ...
                <button class="button-addcopy" onclick="window.top.location.href='ManageBooks-AddCopy-Scan.php';" target="_self"><i class="bi bi-file-earmark-plus"></i> Add Copy</button>
                            ...
                            <div class="ac-book-container">
                                <div>
                                    <div class="ac-label-books">
                                        ...
                                        <button class="admin-editbook"><i class="bi bi-three-dots-vertical"></i></button>
...
<script src="script/BookEditButton.js"></script>
