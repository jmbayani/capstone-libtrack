...
<body>
    ...
    <div class="container-signup">
        <div class="container-info">
            ...
            <h2 class="header1-signup">Copy Added Successfully!!</h2>



            <label class="label2">
                Back to <a class="login-btnlink" onclick="location.href = 'ManageBooks-AllCopies.php';" target="_self" rel="noopener norefer
rer">All Copies</a>
            </label>
