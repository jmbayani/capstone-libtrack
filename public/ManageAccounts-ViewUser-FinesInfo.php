                            ...
                            <div class="container-buttons">
                                ...
                                <div class="settlement-modal" id="settlementModal">
                                    <div class="settlement-modal-content">
                                        ...
                                        <p><strong>Book Title:</strong> War and Peace</p>
                                        <p><strong>Author:</strong> Leo Tolstoy</p>
                                        <p><strong>Penalty Reason:</strong> Damage Pages</p>
                                        <p><strong>Penalty Issued Date:</strong> 12/12/2024</p>
                            ...
                            <div class="grid-userinfo">
                                <div>
                                    <div class="container-booktitle">
                                        ...
                                        <div>
                                            <span class="mb-normallabel">Anxious People</span>
                                        </div>
                                    </div>
                                    <div class="container-author">
                                        <span class="mb-titlelabel">Author</span>
                                        <div>
                                            <span class="mb-normallabel">Fredrick Backman</span>
                                        </div>
                                    </div>
                                    <div class="container-isbn">
                                        <span class="mb-titlelabel">ISBN</span>
                                        <div>
                                            <span class="mb-normallabel">9823-498823-2</span>
                                        </div>
                                    </div>
                                    <div class="container-accessionnum">
                                        <span class="mb-titlelabel">Accession No.</span>
                                        <div>
                                            <span class="mb-normallabel">PCLIB-2024-503</span>
                                        </div>
                                    </div>
                                    <div class="container-status-unsettled">
                                ...
                                <div>
                                    ...
                                    <div class="container-penaltyissueddate">
                                        <span class="mb-titlelabel">Penalty Issued Date:</span>
                                        <div>
                                            <span class="mb-normallabel">12/12/2024</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="container-receiptno">
                                        <span class="mb-titlelabel">Receipt no.</span>
                                        <div>
                                            <span class="mb-normallabel">-</span>
                                        </div>
                                    </div>
                                    <div class="container-settleddate">
                                        <span class="mb-titlelabel">Date Settled:</span>
                                        <div>
                                            <span class="mb-normallabel">-</span>
                                        </div>
                                    </div>
